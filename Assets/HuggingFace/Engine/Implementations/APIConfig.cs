...
namespace HuggingFace.API {
    ...
    public class APIConfig : ScriptableObject, IAPIConfig {
        ...
        [SerializeField] private List<TaskURL> _taskEndpoints;
        ...
        public List<TaskURL> taskEndpoints => _taskEndpoints;
        ...
        public void InitializeTaskEndpoints() {
            ...
            _taskEndpoints = new List<TaskURL>();
            foreach (var taskType in taskTypes) {
                var task = (ITask)Activator.CreateInstance(taskType);
                _taskEndpoints.Add(new TaskURL(task.taskName, task.defaultEndpoint));
            }
        }
        ...
        public void UpdateTaskEndpoints() {
            ...
            foreach (var taskType in taskTypes) {
                ...
                if (existingEndpoint == null) {
                    taskEndpoints.Add(new TaskURL(task.taskName, task.defaultEndpoint));
        ...
        public bool GetTaskEndpoint(string taskName, out TaskURL taskURL) {
